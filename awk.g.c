...
#ifndef YYMAXDEPTH
#define YYMAXDEPTH 100 /* 150 CoCo mem fix */
#endif
#ifndef YYSTYPE
#define YYSTYPE int
#endif
...
yyabort:
  ...
  /* fprintf(stderr, "yyp %d\n", yym); */
	switch(yym){
		
case 1:
# line 41 "awk.g.y"
{ if (errorflg==0) winner = stat3(PROGRAM, yypvt[-2], yypvt[-1], yypvt[-0]); } break;
case 2:
# line 42 "awk.g.y"
